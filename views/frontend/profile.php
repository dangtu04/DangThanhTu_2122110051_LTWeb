...
// $id = $_REQUEST['id'];
// $user = User::find($id);
$user = User::where([['status', '=', 1], ['id', '=', $_SESSION['user_id']]])
   ->first();
         ...
         <div class="col-md-9 order-1 order-md-2">
            ...
            <table class="table table-borderless">
               ...
               <tr>
                  ...
                  <td><?= $user->username; ?><a href="index.php?option=changepassword">Đổi mật khẩu</a> </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td><?= $user->address; ?> <a href="profile_edit.html">Đổi địa chỉ</a> </td>
               </tr>
...
<section class="container py-2">
   <div class="row">
      ...
      <div class="col-md-4 order-md-3">
         <h5 class="list-group-item text-main">Ảnh đại diện</h5>
         <img style="width: 200px; border-radius: 30px;" src="public/images/user/<?= $user->image; ?>" alt="<?= $user->image; ?>">
      </div>
   </div>
</section>
