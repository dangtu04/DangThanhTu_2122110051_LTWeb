   ...
   <section class="content">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-md-6">
                  <a href="index.php?option=page" class="btn btn-primary">Tất cả</a>
               </div>
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <div class="function_style">
                                       <a href="index.php?option=page&cat=retore&id=<?= $item->id; ?>" class="btn btn-info">
                                          <i class="fas fa-undo"></i> Khôi phục</a> |
                                       <a href="index.php?option=page&cat=destroy&id=<?= $item->id; ?>" class="btn btn-danger">
